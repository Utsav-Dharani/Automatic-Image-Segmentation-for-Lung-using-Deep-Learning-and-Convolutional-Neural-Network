...
origins_folder = Path("dataset/images").resolve()
masks_folder = Path("dataset/masks").resolve()
models_folder = Path("models").resolve()
images_folder = Path("images").resolve()
...
print(f"Found {len(origins_list)} images and {len(masks_list)} masks")
...
origin_filename = "dataset\images\CHNCXR_0042_0.png"
